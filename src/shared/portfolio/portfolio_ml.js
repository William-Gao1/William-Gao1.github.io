...
const seo = {
  ...
  description:
    "A passionate and hard working person who loves to learn new things and to tackle interesting problems with Machine Learning. I am an honours student with a record of academic and industry success.",
  og: {
...
const greeting = {
  ...
  subTitle:
    "A passionate and hard working person who loves to learn new things and to to tackle interesting problems with Machine Learning. I am an honours student with a record of academic and industry success.",
  ...
  degrees: [
    {
      ...
      duration: "2020 - 2025",
      descriptions: [
        "⚡ I study data science and machine learning concepts such as Feature Engineering, CNNs, Transformers, Diffusion, SVMs, etc.",
        "⚡ I have also spent a lot of time taking mathematics to obtain a deep understanding of ML models: Statistics, Calculus, Linear Algebra, Numerical Computation, Optimization.",
...
const experience = {
  ...
  description:
    "I have worked with many companies to deliver high-quality ML solutions to both internal and external clients. I am a hardworking, independent, and low-maintanence student who also knows when to ask for help. I love to learn new technologies and often build long term relationsips with my colleagues.",
      ...
      experiences: [
        {
          ...
          points: [
            "Tested a time-stepping PDE solver for the Kolmogorov/Fokker-Plank equation to improve the learning of the forward stochastic diffusion process",
            "Read standard diffusion model papers and implemented their algorithms for testing and comparison",
